...
- 新建或更新 `docs/superpowers/specs/`、`docs/superpowers/plans/` 下的设计稿与实现计划时，默认使用中文撰写；文件标题、章节说明、任务描述、步骤说明、预期结果都应使用中文
- 计划与规格中的代码、命令、路径、类型名可以保留原文，但解释性文字、执行说明与交付说明必须优先使用中文
